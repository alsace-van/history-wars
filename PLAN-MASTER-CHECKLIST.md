...
| **2.6** | **Engagement persistant** ([voir plan](docs/PLAN-ENGAGEMENT-PERSISTENT.md)) | Combat continu : engagement entre 2 unités = état persistant, attrition par tour, relève 10 % réserve. Rompre le combat = 10 % pertes auto. Cav reste ponctuelle (choix Rester/Replier après impact). Tireurs pas d'engagement auto. Synergie moral (−2 / tour engagé). | ⬜ |
